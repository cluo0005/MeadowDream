...
struct DreamHomeView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $showingAddDream, onDismiss: {
                loadDreams()
            }) {
                AddDreamView()
            }
    ...
    private var floatingAddButton: some View {
        Button(action: {
            ...
            Image(systemName: "plus")
                ...
                .clipShape(Circle())
                .shadow(color: Color(red: 0.357, green: 0.498, blue: 1.0).opacity(0.3), radius: 8, x: 0, y: 4)
        }
    }
}
...
struct DreamCardView: View {
    ...
    private func formatDateTime(_ dateString: String) -> String {
        // Convert the date string to a more specific format like "July 15, 2023 • 08:20"
        ...
        return dateString + " • 08:20" // Fallback with time
    }
